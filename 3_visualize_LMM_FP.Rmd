...
for (meas in seq(measures)) {
  ...
  # investigating the coefficient estimates' differences between HRF modeling in npw
  ...
  # investigating the coefficient estimates' differences between HRF modeling in with pw
