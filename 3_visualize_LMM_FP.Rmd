...
dir_plt_std <- file.path(dir_project, "plot", "AC1_RE_std_images")
...
for (meas in seq(measures)) {
  ...
  q$var_cor <- q$var_cor[,1:4,] # to select only standard deviations
  ...
  if(meas == "aci"){  
    zlim_ = list(array(c(0, 0.03),c(2,4)),
                 array(c(0, 0.03),c(2,4)), 
                 array(c(0, 0.45),c(2,4)),
                 array(c(0, 0.45),c(2,4)))
  } else {
    zlim_ = list(array(c(0, 0.026),c(2,4)),
                 array(c(0, 0.026),c(2,4)), 
                 array(c(0, 0.1),c(2,4)),
                 array(c(0, 0.1),c(2,4)))
  }
