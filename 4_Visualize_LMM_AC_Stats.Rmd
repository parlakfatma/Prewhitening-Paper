...
dir_agg <- file.path(dir_project, "AC1_agg") # [FP:we are nit calling this directory, we could remove this line]
...
for (nn in seq(n_fixed)) {
  ...
  plot(
    ...
    together="idx", together_title=names_fixed[nn], 
